...
const ICON_PATHS = {
  ...
  zoomIn: ['M11 18a7 7 0 1 1 0-14 7 7 0 0 1 0 14', 'M21 21l-4.3-4.3', 'M11 8v6', 'M8 11h6'],
  zoomOut: ['M11 18a7 7 0 1 1 0-14 7 7 0 0 1 0 14', 'M21 21l-4.3-4.3', 'M8 11h6'],
  copy: ['M8 8h12v12H8z', 'M4 16V4h12'],
  clipboard: ['M9 4h6', 'M9 2h6v4H9z', 'M5 4h2', 'M17 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2'],
  save: ['M4 4h14l2 2v14H4z', 'M8 4v6h8V4', 'M8 20v-6h8v6'],
  check: ['M20 6 9 17l-5-5'],
  play: ['M8 5v14l11-7z'],
  layout: ['M4 4h6v6H4z', 'M14 4h6v6h-6z', 'M9 14h6v6H9z', 'M7 10v2h10v-2', 'M12 12v2'],
  ...
  gitFork: ['M12 3v5', 'M6 3v3a6 6 0 0 0 6 6v9', 'M18 3v3a6 6 0 0 1-6 6', 'M9 21h6'],
  gitMerge: ['M6 3v3a6 6 0 0 0 6 6v9', 'M18 3v3a6 6 0 0 1-6 6', 'M9 21h6'],
